...
public partial class GodotBenchmarkRunner
{
    ...
    /// <returns>A Taskean indicating whether the benchmark was queued successfully.</returns>
    public static async Task RunWithBBCodeAsync<T>(IConfig? config = null, string[]? args = null, Action<string>? onCallback = null, bool isDebug = false, Action<Summary>? onFinish = null, CancellationToken cancellationToken = default)
    {
    ...
    /// <param name="cancellationToken">A token that can be used to cancel the benchmark.</param>
    /// <returns>A Taskean indicating whether the benchmark was queued successfully.</returns>
    public static async Task RunWithBBCodeAsync(Type type, IConfig? config = null, string[]? args = null, Action<string>? onCallback = null, bool isDebug = false, Action<Summary>? onFinish = null, CancellationToken cancellationToken = default)
    {
        // Check if the operation has been cancelled
        if (cancellationToken.IsCancellationRequested)
        {
    ...
    /// <param name="cancellationToken">A token that can be used to cancel the benchmark.</param>
    /// <returns>A Taskean indicating whether the benchmark was queued successfully.</returns>
    public static async Task RunWithBBCodeAsync(Type type, MethodInfo[] methods, IConfig? config = null, Action<string>? onCallback = null, bool isDebug = false, Action<Summary>? onFinish = null, CancellationToken cancellationToken = default)
    {
        // Check if the operation has been cancelled
        if (cancellationToken.IsCancellationRequested)
        {
    ...
    /// <returns>A Taskean indicating whether the benchmarks were queued successfully.</returns>
    public static async Task RunWithBBCodeAsync(Type[] types, IConfig? config = null, string[]? args = null, Action<Summary, string>? onCallback = null, bool isDebug = false, Action<Summary[]>? onFinish = null, CancellationToken cancellationToken = default)
    {
        if (cancellationToken.IsCancellationRequested)
        {
            return;
    ...
    /// <param name="cancellationToken">A token that can be used to cancel the benchmarks.</param>
    /// <returns>A Taskean indicating whether the benchmarks were queued successfully.</returns>
    public static async Task RunWithBBCodeAsync(Assembly assembly, IConfig? config = null, string[]? args = null, Action<Summary, string>? onCallback = null, bool isDebug = false, Action<Summary[]>? onFinish = null, CancellationToken cancellationToken = default)
    {
        if (cancellationToken.IsCancellationRequested)
        {
            return;
