...
public partial class GodotBenchmarkRunner
{
    ...
    public static bool RunThread<T>(IConfig? config = null, string[]? args = null, bool isDebug = false, Action<Summary>? onFinish = null, CancellationToken cancellationToken = default)
    {
    ...
    /// <param name="cancellationToken">The cancellation token to cancel the benchmark.</param>
    /// <returns>A boolean indicating whether the benchmark was queued successfully.</returns>
    public static bool RunThread(Type type, IConfig? config = null, string[]? args = null, bool isDebug = false, Action<Summary>? onFinish = null, CancellationToken cancellationToken = default)
    {
        if (cancellationToken.IsCancellationRequested)
        {
            return false;
    ...
    public static bool RunThread(Type[] types, IConfig? config = null, string[]? args = null, bool isDebug = false, Action<Summary[]>? onFinish = null, CancellationToken cancellationToken = default)
    {
        if (cancellationToken.IsCancellationRequested)
        {
            return false;
    ...
    /// <param name="cancellationToken">The cancellation token to cancel the benchmark.</param>
    /// <returns>A boolean indicating whether the benchmark was queued successfully.</returns>
    public static bool RunThread(Type type, MethodInfo[] methods, IConfig? config = null, bool isDebug = false, Action<Summary>? onFinish = null, CancellationToken cancellationToken = default)
    {
        if (cancellationToken.IsCancellationRequested)
        {
            return false;
    ...
    /// <param name="cancellationToken">The cancellation token to cancel the benchmarks.</param>
    /// <returns>A boolean indicating whether the benchmarks were queued successfully.</returns>
    public static bool RunThread(Assembly assembly, IConfig? config = null, string[]? args = null, bool isDebug = false, Action<Summary[]>? onFinish = null, CancellationToken cancellationToken = default)
    {
        if (cancellationToken.IsCancellationRequested)
        {
            return false;
