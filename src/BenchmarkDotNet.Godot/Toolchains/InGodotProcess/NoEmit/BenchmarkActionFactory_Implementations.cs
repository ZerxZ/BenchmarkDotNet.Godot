...
public static partial class BenchmarkActionFactory
{
    ...
    public class BenchmarkActionGDTask : BenchmarkActionBase
    {
        private readonly Func<GDTask> startTaskCallback;
        private readonly Action       callback;
        private readonly Action       unrolledCallback;
        ...
        public BenchmarkActionGDTask(object instance, MethodInfo method, int unrollFactor)
        {
            ...
            if (!isIdle)
            {
                startTaskCallback = CreateWorkload<Func<GDTask>>(instance, method);
                callback = ExecuteBlocking;
            }
            else
            {
    ...
    public class BenchmarkActionGDTask<T> : BenchmarkActionBase
    {
